...
/obj/machinery/power/apc/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	var/list/data = list(
		...
		"powerCellStatus" = cell ? percent2(cell) : null,
...
/obj/machinery/power/apc/proc/report()
	return "[area.name] : [equipment]/[lighting]/[environ] ([lastused_equip+lastused_light+lastused_environ]) : [cell? percent2(cell) : "N/C"] ([charging])"
