...
#define ASSET_CACHE_PRELOAD_CONCURRENT 4
...
//		return 0
	...
	while(!client?.completed_asset_jobs.Find(job) && t < timeout_time) // Reception is handled in Topic()
...
/proc/getFilesSlow(var/client/client, var/list/files, var/register_asset = TRUE)
	...
	for(var/file in files)
		...
		stoplag() //queuing calls like this too quickly can cause issues in some client versions
