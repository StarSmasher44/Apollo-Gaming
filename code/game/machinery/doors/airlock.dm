...
/obj/machinery/door/airlock/open(var/forced=0)
	if(!can_open(forced))
		return 0
	use_power_oneoff(360)		// Uses bunch extra power for crushing the target.	//360 W seems much more appropriate for an actuator moving an industrial door capable of crushing people
...
/obj/machinery/door/airlock/close(var/forced=0)
	...
	use_power_oneoff(360)	//360 W seems much more appropriate for an actuator moving an industrial door capable of crushing people	if(arePowerSystemsOn())
	if(arePowerSystemsOn())
